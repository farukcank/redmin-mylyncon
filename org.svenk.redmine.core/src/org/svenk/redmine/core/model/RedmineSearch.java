...
public class RedmineSearch {
	...
	public final static String DATA_KEY = "PROJECT_NAME";
	...
	public static RedmineSearch fromSearchQueryParam(IRedmineSearchData queryData, String param, String repositoryUrl) {
		...
		List<RedmineCustomField> customFields = 
			RedmineSearchFilter.findCustomTicketFieldsFromSearchQueryParam(queryData, param);
